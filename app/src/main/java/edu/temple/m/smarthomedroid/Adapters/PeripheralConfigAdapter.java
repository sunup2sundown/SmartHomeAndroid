...
public class PeripheralConfigAdapter extends BaseExpandableListAdapter{
    ...
    public int getChildrenCount(int groupPosition) {
        if ((this.children==null)||this.children.get(this.header.get(groupPosition))==null||this.children.isEmpty()){
            return 0;
        }else{
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView boardname = (TextView)convertView.findViewById(R.id.config_board_name);
        TextView boardquantity = (TextView)convertView.findViewById(R.id.config_quantity);
