...
public class JoinHouseDialogFragment extends DialogFragment {
    ...
    JoinHouseDialogListener mListener;

    /* The activity that creates instance of dialog fragment must implement
    *  this interface in order to recieve event callbacks
     */
    public interface JoinHouseDialogListener{
        public void onJoinHouseDialogPositiveClick(DialogFragment dialog);
        public void onJoinHouseDialogNegativeClick(DialogFragment dialog);
    }
    ...
    public void onAttach(Activity activity){
        ...
        try{
            ...
            mListener = (JoinHouseDialogListener) activity;
        } catch(ClassCastException e){
            //Activity doesn't implement
            throw new ClassCastException(activity.toString() + " must implement JoinHouseDialogListener");
        }
    }
        ...
        builder.setView(inflater.inflate(R.layout.dialog_join_house, null))
                .setPositiveButton("Join", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface dialog, int id){
                        ...
                        mListener.onJoinHouseDialogPositiveClick(JoinHouseDialogFragment.this);
                    }
                })
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener(){
                    public void onClick(DialogInterface dialog, int id){
                        //send the negative button event back to host activity
                        mListener.onJoinHouseDialogNegativeClick(JoinHouseDialogFragment.this);
                    }
                });
